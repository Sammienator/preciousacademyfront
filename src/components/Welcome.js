...
function Welcome() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-dark-black flex flex-col items-center justify-center py-12 px-6 relative">
      <Link
        to="/register"
        className="absolute top-4 right-4 text-deep-blue dark:text-aqua hover:underline transition duration-300"
      >
        Register New User
      </Link>
